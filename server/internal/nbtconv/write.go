 ...
 import ( 
         ...
         "github.com/PocketMiner92/magic-alpaca/server/world/chunk" 
 ...
 // writeMagic-AlpacaData writes additional data associated with an item.Stack to a map for NBT encoding. 
